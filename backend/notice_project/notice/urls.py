...
from .views import install, sidebar, create_room, CreateNewNotices, UpdateNoticeAPIView, search, get_room, ViewNoticeAPI
...
urlpatterns = [
    ...
    path('organizations/<str:org_id>/update-notice',
